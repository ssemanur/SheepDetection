# -*- coding: utf-8 -*-
"""
Created on Sun Jan  3 20:36:17 2021
...
cap = cv2.VideoCapture("koyunlar.mp4")
...
#%%2.Bölüm
    ...
    colors = ["23,45,67","38,165,233","21,54,98","78,109,68","0,0,35"]
...
##############NON_MAXIMUM SUPPRESSION - OPERATION 1 ###########################
    ids_list=[]
    boxes_list = []
    confidences_list =[]
    ...
    for detection_layer in detection_layers:
        for object_detection in detection_layer:
            ...
            if confidence > 0.30:
                ...
                ##############NON_MAXIMUM SUPPRESSION - OPERATION 2 ###########################
...
##############NON_MAXIMUM SUPPRESSION - OPERATION 3 ###########################
